...
// Load modules
var modules = {};
modules.helpers = require( ".Assets/app/helpers.js" );
modules.blocks = require( ".Assets/app/blocks.js" );
modules.world = require( ".Assets/app/world.js" );
modules.network = require( ".Assets/app/network.js" );
var serv = app.listen(8080);
modules.io = require( "socket.io" ).listen(serv);
